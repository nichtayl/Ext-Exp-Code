function [hasCSpk, CSpkChangeDir, CSpkToEventProb, medianCSpkLatency,...
    ...
    triggerTimes, ssBinSize, sortedPreTime, winOfInterest, makeFig)
        ...
        [hasCSpk, outlyingnessCSpk, CSpkChangeDir, CSpkToEventProb, spikeProbs] = ...
            ...
            triggerTimes, sortedPreTime, winOfInterest,...
            'probability', makeFig);
        if hasCSpk 
            % check the latency of the responses to the puff
            [cspklatsummary] = ...
                getLatencies_lowProbEvent(CSpk_times, triggerTimes, triggerTimes+winOfInterest);
        ...
        [hasSS, outlyingnessSS, SSChangeDir, SSToEventRate, resp] = ...
            ...
            trialTimes, triggerTimes, sortedPreTime, winOfInterest, 'frequency', makeFig);
        if hasSS
            ...
            [SSLat, SSDeviation, medianabsdev, medianval, thisval] = ...
                getLatencies_fastEvent(SS_times, trialTimes, triggerTimes, sortedPreTime,...
