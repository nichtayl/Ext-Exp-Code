...
[eyelidTrace.during] = trialsAndDatesIntoEyelidTraces(txt, raw, rbdatDayData, 'during');
[eyelidTrace.after] = trialsAndDatesIntoEyelidTraces(txt, raw, rbdatDayData, 'after');
[eyelidTrace.late] = trialsAndDatesIntoEyelidTraces(txt, raw, rbdatDayData, 'late');
[eyelidTrace.early] = trialsAndDatesIntoEyelidTraces(txt, raw, rbdatDayData, 'early');

% mean eyelid traces from first, second, fourth, and last days
...
[plottedTraces] = plotEyelidTraces(eyelidTrace.during.mean, [1,2,3,4], ...
    [2,3,4,6,8;2,3,4,6,9;2,3,4,6,12;2,3,4,6,12], timeVector, legendLabels,...
...
% stopped editing here because I was getting an obvious problem
